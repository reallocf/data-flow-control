#!/usr/bin/env python3
"""Run the state-transition UPDATE experiment."""
# ruff: noqa: I001
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run the state-transition UPDATE experiment.")
    ...
    print("Running state-transition UPDATE experiment:")
    ...
    print("  Approaches: No Policy, 1Phase")
    ...
    config = ExperimentConfig(
        ...
        output_dir="./results",
        output_filename="state_transition_results.csv",
        verbose=True,
    )

    runner = ExperimentRunner(StateTransitionStrategy(), config)
