...
EXPECTED_PHYSICAL_SQL = {
    1: 'WITH lineage AS (SELECT lineage.out_index FROM (SELECT "output_id" AS out_index, "opid_0_test_data" AS "test_data" FROM READ_BLOCK(0)) AS lineage JOIN test_data ON CAST(test_data.rowid AS BIGINT) = CAST(lineage.test_data AS BIGINT) GROUP BY lineage.out_index HAVING MAX(test_data.value) > 100) SELECT generated_table."category", generated_table."count", generated_table."total_amount" FROM temp_table_name AS generated_table JOIN lineage ON CAST(generated_table.rowid AS BIGINT) = CAST(lineage.out_index AS BIGINT)',
...
EXPECTED_PHYSICAL_SQL_10_POLICIES = {
    1: 'WITH lineage AS (SELECT lineage.out_index FROM (SELECT "output_id" AS out_index, "opid_0_test_data" AS "test_data" FROM READ_BLOCK(0)) AS lineage JOIN test_data ON CAST(test_data.rowid AS BIGINT) = CAST(lineage.test_data AS BIGINT) GROUP BY lineage.out_index HAVING (MAX(test_data.value) > 100) AND (MAX(test_data.value) > 101) AND (MAX(test_data.value) > 102) AND (MAX(test_data.value) > 103) AND (MAX(test_data.value) > 104) AND (MAX(test_data.value) > 105) AND (MAX(test_data.value) > 106) AND (MAX(test_data.value) > 107) AND (MAX(test_data.value) > 108) AND (MAX(test_data.value) > 109)) SELECT generated_table."category", generated_table."count", generated_table."total_amount" FROM temp_table_name AS generated_table JOIN lineage ON CAST(generated_table.rowid AS BIGINT) = CAST(lineage.out_index AS BIGINT)',
    10: 'WITH lineage AS (SELECT lineage.out_index FROM (SELECT "output_id" AS out_index, "opid_0_test_data" AS "test_data" FROM READ_BLOCK(0)) AS lineage JOIN test_data ON CAST(test_data.rowid AS BIGINT) = CAST(lineage.test_data AS BIGINT) GROUP BY lineage.out_index HAVING (MAX(test_data.value) > 100) AND (MAX(test_data.value) > 101) AND (MAX(test_data.value) > 102) AND (MAX(test_data.value) > 103) AND (MAX(test_data.value) > 104) AND (MAX(test_data.value) > 105) AND (MAX(test_data.value) > 106) AND (MAX(test_data.value) > 107) AND (MAX(test_data.value) > 108) AND (MAX(test_data.value) > 109)) SELECT generated_table."category", generated_table."count", generated_table."total_amount" FROM temp_table_name AS generated_table JOIN lineage ON CAST(generated_table.rowid AS BIGINT) = CAST(lineage.out_index AS BIGINT)',
}
