...
HAVING MAX(((((((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey))))) + (((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))))) + ((((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey))))) + (((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey))))))) + (((((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey))))) + (((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))) + ((((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax))) + (((lineitem.l_linenumber) + (lineitem.l_orderkey)) + ((lineitem.l_partkey) + (lineitem.l_suppkey)))))) + (((lineitem.l_quantity) + (lineitem.l_extendedprice)) + ((lineitem.l_discount) + (lineitem.l_tax)))))) >= 0
)
SELECT
...
JOIN lineitem
    ON lineitem.rowid::bigint = lineage.lineitem::bigint
GROUP BY lineage.out_index
HAVING MAX(lineitem.l_quantity) >= 0 OR MAX(lineitem.l_quantity + 1) >= 0 OR MAX(lineitem.l_extendedprice + 2) >= 0 OR MAX(lineitem.l_discount + 3) >= 0 OR MAX(lineitem.l_tax + 4) >= 0 OR MAX(lineitem.l_linenumber + 5) >= 0 OR MAX(lineitem.l_orderkey + 6) >= 0 OR MAX(lineitem.l_partkey + 7) >= 0 OR MAX(lineitem.l_suppkey + 8) >= 0 OR MAX(lineitem.l_quantity + 9) >= 0 OR MAX(lineitem.l_extendedprice + 10) >= 0 OR MAX(lineitem.l_discount + 11) >= 0 OR MAX(lineitem.l_tax + 12) >= 0 OR MAX(lineitem.l_linenumber + 13) >= 0 OR MAX(lineitem.l_orderkey + 14) >= 0 OR MAX(lineitem.l_partkey + 15) >= 0 OR MAX(lineitem.l_suppkey + 16) >= 0 OR MAX(lineitem.l_quantity + 17) >= 0 OR MAX(lineitem.l_extendedprice + 18) >= 0 OR MAX(lineitem.l_discount + 19) >= 0 OR MAX(lineitem.l_tax + 20) >= 0 OR MAX(lineitem.l_linenumber + 21) >= 0 OR MAX(lineitem.l_orderkey + 22) >= 0 OR MAX(lineitem.l_partkey + 23) >= 0 OR MAX(lineitem.l_suppkey + 24) >= 0 OR MAX(lineitem.l_quantity + 25) >= 0 OR MAX(lineitem.l_extendedprice + 26) >= 0 OR MAX(lineitem.l_discount + 27) >= 0 OR MAX(lineitem.l_tax + 28) >= 0 OR MAX(lineitem.l_linenumber + 29) >= 0 OR MAX(lineitem.l_orderkey + 30) >= 0 OR MAX(lineitem.l_partkey + 31) >= 0 OR MAX(lineitem.l_suppkey + 32) >= 0 OR MAX(lineitem.l_quantity + 33) >= 0 OR MAX(lineitem.l_extendedprice + 34) >= 0 OR MAX(lineitem.l_discount + 35) >= 0 OR MAX(lineitem.l_tax + 36) >= 0 OR MAX(lineitem.l_linenumber + 37) >= 0 OR MAX(lineitem.l_orderkey + 38) >= 0 OR MAX(lineitem.l_partkey + 39) >= 0 OR MAX(lineitem.l_suppkey + 40) >= 0 OR MAX(lineitem.l_quantity + 41) >= 0 OR MAX(lineitem.l_extendedprice + 42) >= 0 OR MAX(lineitem.l_discount + 43) >= 0 OR MAX(lineitem.l_tax + 44) >= 0 OR MAX(lineitem.l_linenumber + 45) >= 0 OR MAX(lineitem.l_orderkey + 46) >= 0 OR MAX(lineitem.l_partkey + 47) >= 0 OR MAX(lineitem.l_suppkey + 48) >= 0 OR MAX(lineitem.l_quantity + 49) >= 0 OR MAX(lineitem.l_extendedprice + 50) >= 0 OR MAX(lineitem.l_discount + 51) >= 0 OR MAX(lineitem.l_tax + 52) >= 0 OR MAX(lineitem.l_linenumber + 53) >= 0 OR MAX(lineitem.l_orderkey + 54) >= 0 OR MAX(lineitem.l_partkey + 55) >= 0 OR MAX(lineitem.l_suppkey + 56) >= 0 OR MAX(lineitem.l_quantity + 57) >= 0 OR MAX(lineitem.l_extendedprice + 58) >= 0 OR MAX(lineitem.l_discount + 59) >= 0 OR MAX(lineitem.l_tax + 60) >= 0 OR MAX(lineitem.l_linenumber + 61) >= 0 OR MAX(lineitem.l_orderkey + 62) >= 0 OR MAX(lineitem.l_partkey + 63) >= 0 OR MAX(lineitem.l_suppkey + 64) >= 0 OR MAX(lineitem.l_quantity + 65) >= 0 OR MAX(lineitem.l_extendedprice + 66) >= 0 OR MAX(lineitem.l_discount + 67) >= 0 OR MAX(lineitem.l_tax + 68) >= 0 OR MAX(lineitem.l_linenumber + 69) >= 0 OR MAX(lineitem.l_orderkey + 70) >= 0 OR MAX(lineitem.l_partkey + 71) >= 0 OR MAX(lineitem.l_suppkey + 72) >= 0 OR MAX(lineitem.l_quantity + 73) >= 0 OR MAX(lineitem.l_extendedprice + 74) >= 0 OR MAX(lineitem.l_discount + 75) >= 0 OR MAX(lineitem.l_tax + 76) >= 0 OR MAX(lineitem.l_linenumber + 77) >= 0 OR MAX(lineitem.l_orderkey + 78) >= 0 OR MAX(lineitem.l_partkey + 79) >= 0 OR MAX(lineitem.l_suppkey + 80) >= 0 OR MAX(lineitem.l_quantity + 81) >= 0 OR MAX(lineitem.l_extendedprice + 82) >= 0 OR MAX(lineitem.l_discount + 83) >= 0 OR MAX(lineitem.l_tax + 84) >= 0 OR MAX(lineitem.l_linenumber + 85) >= 0 OR MAX(lineitem.l_orderkey + 86) >= 0 OR MAX(lineitem.l_partkey + 87) >= 0 OR MAX(lineitem.l_suppkey + 88) >= 0 OR MAX(lineitem.l_quantity + 89) >= 0 OR MAX(lineitem.l_extendedprice + 90) >= 0 OR MAX(lineitem.l_discount + 91) >= 0 OR MAX(lineitem.l_tax + 92) >= 0 OR MAX(lineitem.l_linenumber + 93) >= 0 OR MAX(lineitem.l_orderkey + 94) >= 0 OR MAX(lineitem.l_partkey + 95) >= 0 OR MAX(lineitem.l_suppkey + 96) >= 0 OR MAX(lineitem.l_quantity + 97) >= 0 OR MAX(lineitem.l_extendedprice + 98) >= 0 OR MAX(lineitem.l_discount + 99) >= 0 OR MAX(lineitem.l_tax + 100) >= 0
)
SELECT
    generated_table."l_returnflag", generated_table."l_linestatus", generated_table."sum_qty", generated_table."sum_base_price", generated_table."sum_disc_price", generated_table."sum_charge", generated_table."avg_qty", generated_table."avg_price", generated_table."avg_disc", generated_table."count_order"
FROM {temp_table_name} AS generated_table
